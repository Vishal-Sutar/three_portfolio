          ...
          <div>
            ...
            <p className="grid-subtext">
              ...
              and responsive websites.
                ...
                <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            <img src="assets/mern.jpg" alt="grid-2" className="w-full sm:h-[276px] h-fit object-contain" />

            <div>
              <p className="grid-headtext">Tech Stack</p>
              <p className="grid-subtext">
                I specialize in html, js, css, react and tools that allow me to build robust and scalable
                applications.
              </p>
            </div>
          </div>
        ...
        <div className="col-span xl:row-span-4">
                ...
                <div className="xl:col-span-2 xl:row-span-3 ">
                    <div className="grid-container">
                        ...
                        <div>
                          <p className="grid-headtext">My Passion For Web Dev</p>
                          <p className="grid-subtext">I love web development and building things through coding.</p>
                        </div>
                ...
                <div className="xl:col-span-1 xl:row-span-2">
                  <div className="grid-container">
                      <img src="/assets/grid4.png" alt="grid-4"className="w-full md:h-[126px] sm:h-[276px]
                               h-fit object-coveer sm:object-top" />
